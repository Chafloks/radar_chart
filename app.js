...
function buildPlot(pokemon) {
    ...
    d3.json(url).then(function(data) {
        ...
        type: 'radar',
        data: {
        labels: [hp_name, attack_name, defense_name, special_attack_name, special_defense_name,speed_name],
        datasets: [{
            data: [hp_no, attack_no, defense_no, special_attack_no, special_defense_no, speed_no]
            }]
            },
        options: {
                elements: {
